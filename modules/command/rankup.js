...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
	...
	if (level > curLevel && level != 1) {
		...
		if (existsSync(__dirname + `/cache/rankup/${event.threadID}.gif`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/cache/rankup/${event.threadID}.gif`
